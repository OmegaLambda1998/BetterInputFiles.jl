...
- `custom_metadata::Vector{Tuple{String, String}}=Vector{Tuple{String, String}}()`: Additional metadata to include in the input file, in addition to creation date and `input_path`
"""
